...
type OnVerifyProps = {
    onVerify: (e: React.FormEvent<HTMLFormElement>) => Promise<void>;
};
        ...
        <div className="w-full h-[100vh] text-gray-300 font-mono flex flex-col items-center justify-center">
            <div className='md:w-1/2 sm:w-11/12 xs:w-full py-12 flex flex-col items-center justify-center'>
                ...
                <Suspense fallback={<Loader />}>
                    <VerifyEmailInner onVerify={onVerify} />
                </Suspense>
...
const VerifyEmailInner = ({ onVerify }: { onVerify: (event: React.MouseEvent<HTMLButtonElement>) => Promise<void> }) => {
