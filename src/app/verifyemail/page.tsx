...
const VerifyEmail = () => {
    ...
    return (
        <div className="w-full h-[100vh] text-gray-300 font-mono flex flex-col items-center">
            <div className='w-1/2 py-12 flex flex-col items-center'>
                {loading ? <Loader /> : null}
                <h1 className='text-4xl font-semibold py-6'>Verify Your Email</h1>
                ...
                <button id="button" name="button" type="submit"  {...token === '' ? { disabled: true } : ''} className="flex justify-center items-center py-3 my-6 w-96 bg-gray-800 text-gray-100 outline-none outline-offset-0 border-none cursor-pointer transition-all duration-400 hover:bg-gray-100 hover:text-orange-500" onClick={onVerify}>
